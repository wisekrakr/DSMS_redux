...
const Froggy = function(game,x ,y) {
    ...
    this.velocity_x = ENEMY_SPEED / FPS;
    this.velocity_y = ENEMY_SPEED / FPS;
    this.x          = x;
    this.y          = y;    
    this.angle      = 0;  
    this.rotation   = 0;    
...
Froggy.prototype = {
    ...
    */
    collide: function () {     
        if(this.following){  
            if(this.game.gameEngine.collisionObject(this) instanceof Laser || 
          ...
          if(target instanceof Player){    
            ...
            if(this.target !== null){
                if(this.game.gameEngine.distanceBetweenObjects(this,target) < 250){
                    ...
                    if(this.game.gameEngine.distanceBetweenObjects(this,target) < target.width * 3){
    ...
    update: function() {        
        ...
        if(this.collide()){            
            ...
            if(this.collided_with instanceof Asteroid || this.collided_with instanceof Laser){               
